...
def BFS(n, edges, saabolobur, recipes, morids , startLoc, moridRecipes, moridCountInEachLoc):
...
start = time.time()
goal , visitedStatesCount = BFS(n, edges, saabolobur, recipes, deepcopy(morids) , startLoc, moridRecipes, moridCountInEachLoc)
